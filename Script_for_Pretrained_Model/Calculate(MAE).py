...
if __name__=='__main__':
    src_dir=r'D:\GAN\pytorch-CycleGAN-and-pix2pix\datasets\Change of AR\Test\Change of AR_TO_test'
    target_dir=r'D:\GAN\pytorch-CycleGAN-and-pix2pix\datasets\Change of AR\Test\Change of AR_AM_test'
    model_dir=r'checkpoints/GAN_Control_Ensemble_pix2pix_aligned_Unet_jit'
    ...
    if 'latest_net_G_3_256_256_jit.pt' in model_list:
        model_list.remove('latest_net_G_3_256_256_jit.pt')
    ...
    for model_file in model_list:
        ...
        with torch.no_grad():
            for idx,file in enumerate(file_list):
                ...
                predict_img=picture_strengthen(GAN_generator,file_path,device)
                # GT
